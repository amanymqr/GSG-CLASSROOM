        ...
        <img src="https://placehold.co/150x6" class="card-img-top img-fluid" alt="">  --}}
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ $classroom->url }}" class="btn"><i
                            class="bi bi-arrows-fullscreen"></i></a>

                    <a href="{{ route('classroom.edit', $classroom->id) }}" class="btn"><i class="bi bi-pen"></i></a>

                    <form action="{{ route('classroom.destroy', $classroom->id) }}" method="post"
                        class="d-inline-block">
                        @csrf
                        @method('delete')
                        <button class="btn" onclick="return confirm('Are you sure')"><i
